...
#resume_item[
    - Reviewed internal and external PRs and designs to enhance product quality, performance, and security. Contributed to the internal standardization committee.
    - Mentored engineers, enforced standards, and elevated engineering culture. Conducted training sessions on asynchronous programming in Kotlin.
